...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        # # Kernel configuration (gaussian | gamma)
        # self.kernel_type     = "gaussian"
        # self.gamma_m         = 10.0
        # self.gamma_kappa     = 1.0
        # self.gamma_eps_scale = 1.0
        self.use_laplacian         = False
        self.laplacian_start_iter  = 3000
        self.laplacian_lambda      = 0.1

        self.upsample_from     = 0
        self.upsample_interval = 4000
        self.upsample_until    = 13_000
        self.resample_from     = 3000
        ...
        self.stochastic_preconditioning = False
        self.sp_alpha = 0.01
